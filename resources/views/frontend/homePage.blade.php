                    ...
                    <div class="banner-slider-one pagination-square align-pagination-square">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="single-banner-slider">
                                        <img src="{{ asset('frontend/assets/img/slider/slide-01.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="banner-slider-single banner-animation-col">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="single-banner-slider">
                                        <img src="{{ asset('frontend/assets/img/slider/slide-03.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="banner-slider-single banner-animation-col">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="single-banner-slider">
                                        <img src="{{ asset('frontend/assets/img/slider/slide-02.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="digital-group  wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <div class="pharmacy-equipments">
                                <div class="digital-pharmacy">
                                    ...
                                    <h2>$149.00</h2>
                                    <span>$159.00</span>
                                    <h4><a href="view-product.html">Shop Now <i class="feather-arrow-right ml-5"></i></a>
                                    </h4>
                                </div>
                                <div class="digital-shop-img">
                                    <a href="view-product.html">
                                        <img class="default-img" src="{{ asset('frontend/assets/img/shop/shop-01.jpg') }}"
                                            alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6 d-flex">
                        <div class="digital-group  wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <div class="pharmacy-equipments">
                                ...
                                <div class="digital-shop-img">
                                    <a href="view-product.html">
                                        <img class="default-img" src="{{ asset('frontend/assets/img/shop/shop-02.jpg') }}"
                                            alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6 d-flex">
                        <div class="digital-group  wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <div class="pharmacy-equipments">
                                ...
                                <div class="digital-shop-img">
                                    <a href="view-product.html">
                                        <img class="default-img" src="{{ asset('frontend/assets/img/shop/shop-03.jpg') }}"
                                            alt="">
                                    </a>
                                </div>
                            </div>
