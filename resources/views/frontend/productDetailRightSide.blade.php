                            ...
                            <div class="row mb-50">
                                <div class="col-md-5 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="slider-nav-thumbnails">
                                            <div><img src="{{ asset('frontend/assets/img/shop/product-small-02.jpg') }}" alt="product image"></div>
                                            <div><img src="{{ asset('frontend/assets/img/shop/product-small-03.jpg') }}" alt="product image"></div>
                                            <div><img src="{{ asset('frontend/assets/img/shop/product-small-02.jpg') }}" alt="product image"></div>
                                            <div><img src="{{ asset('frontend/assets/img/shop/product-small-03.jpg') }}" alt="product image"></div>
                                            <div><img src="{{ asset('frontend/assets/img/shop/product-small-02.jpg') }}" alt="product image"></div>
                                            <div><img src="{{ asset('frontend/assets/img/shop/product-small-03.jpg') }}" alt="product image"></div>
                                ...
                                <div class="col-md-7 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="pop-wish">
                                            <a aria-label="Add To Wishlist" class=" link-wishlist" href="wishlist.html"><i class="feather-shopping-bag me-1 ms-1"></i>Add to Wishlist</a>
                                        </div>
                                        <div class="pro-share">
                                            <ul>
                                    ...
                                    <div class="view-detail-tab">
                                        <div class="tab-content shop_info_tab entry-main-content">
                                            ...
                                            <div class="tab-pane review-tab fade" id="Review"> 
                                                ...
                                                <div class="review-group mb-10">
                                                    <div class="review-img">
                                                        <a href="profile.html"><img src="{{ asset('frontend/assets/img/user/user-03.jpg') }}" alt="img" class="img-fluid"></a>
                                                    </div>
                                                    <div class="review-name-group">
                                                        <h5><a href="profile.html">Teri Jennings</a> <span>11 months age</span></h5>
                                                        <div class="review-card-bottom ">
                                                ...
                                                <div class="review-group mb-10">
                                                    <div class="review-img">
                                                        <a href="profile.html"><img src="{{ asset('frontend/assets/img/user/user-02.jpg') }}" alt="img" class="img-fluid"></a>
                                                    </div>
                                                    <div class="review-name-group">
                                                        <h5><a href="profile.html">Teri Jennings</a> <span>11 months age</span></h5>
                                                        <div class="review-card-bottom ">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="feature-product-slider arrow-center position-relative">
                                                <div class="slider-arrow slider-arrow-two carousel-4-columns-arrow" id="carousel-7-columns-arrows"></div>
                                                <div class="carousel-7-columns carousel-arrow-center mb-0" id="carousel-7-columns">
                                                <!-- Product box -->
                                ...
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" id="accordionExample">
                                        <li class="nav-item" id="dashboard-one">
                                            <a class="nav-link active accordion-button" href="#" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Diagnosis <i class="feather-plus "></i></a>
